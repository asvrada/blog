...
Post: https://leetcode.com/problems/word-ladder-ii/discuss/1178481/java-bi-bfs-dfs-with-set-5ms

This is a natural extension of the solution from 127. Word Ladder
https://leetcode.com/problems/word-ladder/discuss/1178426/java-bi-bfs-with-set-12ms

We use the solution from `127. Word Ladder` to get the shortest number of words in the path, while building the graph. Then use DFS to generate all the possible paths given the graph and shortest length.
...
class Solution {
    ...
    public int bfs(Map<String, Set<String>> graph, String beginWord, String endWord, List<String> wordList) {
    ...
    void dfs(List<List<String>> ans, List<String> path, int targetLength, String beginWord, String endWord, Map<String, Set<String>> graph) {
        path.add(beginWord);
